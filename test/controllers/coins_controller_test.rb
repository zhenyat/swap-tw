...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference("Coin.count") do
      post coins_url, params: { coin: { code: @coin.code, kind: @coin.kind, name: @coin.name, status: @coin.status, unicode: @coin.unicode } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { code: @coin.code, kind: @coin.kind, name: @coin.name, status: @coin.status, unicode: @coin.unicode } }
